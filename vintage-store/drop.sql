...
alter table if exists t_tracks drop constraint if exists FK6w08be4wobnfbnqb52f6i96d1
...
alter table if exists t_purchase_order_lines drop constraint if exists FK3dvmgquehp4me8g818j62j3co
alter table if exists t_tracks drop constraint if exists FK6w08be4wobnfbnqb52f6i96d1
drop table if exists t_artists cascade
drop table if exists t_customers cascade
drop table if exists t_items cascade
