...
create sequence hibernate_sequence start with 1 increment by 1
create table Publisher (id bigint not null, name varchar(30), primary key (id))
create table t_items (DTYPE varchar(31) not null, id bigint not null, description varchar(3000), price decimal(19,2), title varchar(255), isbn varchar(15), language varchar(255), nb_of_pages integer, publication_date date, genre varchar(255), music_company varchar(255), publisher_pk bigint, primary key (id))
create table t_items_Track (CD_id bigint not null, tracks_id bigint not null)
create table Track (id bigint not null, duration bigint, title varchar(255), primary key (id))
alter table t_items_Track add constraint UK_5os3y4e5dka73gxbae24kkkmi unique (tracks_id)
alter table t_items add constraint FKqqrdsr9wa61kmlo0lncqv5ari foreign key (publisher_pk) references Publisher
alter table t_items_Track add constraint FKt5xn8qbfvmjqe2y3pj52d6wkh foreign key (tracks_id) references Track
alter table t_items_Track add constraint FK6sae9f1gr4cfo8dsw83s91gwb foreign key (CD_id) references t_items
...
create sequence hibernate_sequence start with 1 increment by 1
create table Publisher (id bigint not null, name varchar(30), primary key (id))
create table t_items (DTYPE varchar(31) not null, id bigint not null, description varchar(3000), price decimal(19,2), title varchar(255), genre varchar(255), music_company varchar(255), isbn varchar(15), language varchar(255), nb_of_pages integer, publication_date date, publisher_pk bigint, primary key (id))
create table t_items_Track (CD_id bigint not null, tracks_id bigint not null)
create table Track (id bigint not null, duration bigint, title varchar(255), primary key (id))
alter table t_items_Track add constraint UK_5os3y4e5dka73gxbae24kkkmi unique (tracks_id)
alter table t_items add constraint FKqqrdsr9wa61kmlo0lncqv5ari foreign key (publisher_pk) references Publisher
